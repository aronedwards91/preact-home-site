export const NonFictionBooks = [
  ...
  //   },
  {
    ...
    sub: "Dale Carnegie",
    text:
      "One of the original self-help books, and one of the best selling books of all time.",
    moreText: `The book contains four sections of skills & techniques import to building effective social & business communication skills.

    1) Fundamental Techniques;
[a] Don't criticise, condemn or complain (this results in a very human reaction of defensiveness & annoyance).
...
[a] Take the time to discover the complexities of others (Once you have a genuine interest in others, others will become more interested in you).
...
[a] You cannot win an argument, avoid them (Only cooperation or understanding is a win, to humiliate or beat others in no victory at all. Distrust your first impressions, find areas of agreement, and take time to study the other’s ideas).
...
4) Be a Leader
[a] Begin with praise & honest appreciation (A leader that gives sincere, real praise is one that is listening and worth of reciprocal respect).
...
`
  },
  {
    ...
    moreText: `In his very popular and well regarded book, Mr. Covey highlights 7 habits that produce particularly effective results in improving the quality of your life.
...
`
  },
  {
    ...
    moreText: `
A) Charisma as Skill;
A powerful indicator of business success.
